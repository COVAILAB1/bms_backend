...
// MongoDB connection
const uri = 'mongodb+srv://covailabs1:KRISHtec%405747@bmsdashboard.upate.mongodb.net/test?retryWrites=true&w=majority';
mongoose.connect(uri, { useNewUrlParser: true, useUnifiedTopology: true })
    .then(() => console.log('MongoDB connected to the test database'))
...
// Use the collection name 'bmsdata' explicitly
const BMS = mongoose.model('BMS', bmsSchema, 'bmsdatas');
